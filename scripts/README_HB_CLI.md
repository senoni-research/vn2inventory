...
```bash
# Graph with cap (winning submission)
...
3. Run: `python scripts/run_hb_solution.py --model graph-enhanced --output-dir submissions/final --apply-cap`
4. Submit: `submissions/final/orders_hierarchical_graph_enhanced_cv.csv`
...
The final submission is in `submissions/final/`. All checks pass. Ship it! 🏆
